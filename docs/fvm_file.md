...
Frame indices are diagnostic only. Gaps, duplicates, and out-of-order indices are recorded but never used as expected truth or to help correction. FOV block/symbol identifiers provide unordered recovery and symbol deduplication.
